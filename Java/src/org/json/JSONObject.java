 ...
 * Values may be any mix of {@link JSONObject JSONObjects}, {@link org.json.JSONArray
...
public class JSONObject {
     ...
     *
     * @param value a {@link JSONObject}, {@link org.json.JSONArray}, String, Boolean,
     ...
     * {@link org.json.JSONArray}. Using {@code accumulate} will result in either a
     * {@link org.json.JSONArray} or a mapping whose type is the type of {@code value}
    ...
    public JSONObject accumulate(String name, Object value) throws JSONException {
        ...
        if (current instanceof org.json.JSONArray) {
            org.json.JSONArray array = (org.json.JSONArray) current;
    ...
    /**
     * Appends values to the array mapped to {@code name}. A new {@link org.json.JSONArray}
     * mapping for {@code name} will be inserted if no mapping exists. If the existing
     * mapping for {@code name} is not a {@link org.json.JSONArray}, a {@link JSONException}
     * will be thrown.
     *
     * @throws JSONException if {@code name} is {@code null} or if the mapping for
     *         {@code name} is non-null and is not a {@link org.json.JSONArray}.
     *
     * @hide
     */
    public JSONObject append(String name, Object value) throws JSONException {
        ...
        if (current instanceof org.json.JSONArray) {
            array = (org.json.JSONArray) current;
     ...
     *     JSONArray}.
     */
    public org.json.JSONArray getJSONArray(String name) throws JSONException {
        Object object = get(name);
    ...
    public org.json.JSONArray optJSONArray(String name) {
        Object object = opt(name);
        return object instanceof org.json.JSONArray ? (org.json.JSONArray) object : null;
    }
     ...
     */
    public org.json.JSONArray toJSONArray(org.json.JSONArray names) throws JSONException {
    ...
    public org.json.JSONArray names() {
        return nameValuePairs.isEmpty()
                ? null
                : new org.json.JSONArray(new ArrayList<String>(nameValuePairs.keySet()));
    }
    ...
    public static Object wrap(Object o) {
        ...
        if (o instanceof org.json.JSONArray || o instanceof JSONObject) {
            return o;
        }
        if (o.equals(NULL)) {
            return o;
        ...
        try {
            if (o instanceof Collection) {
                ...
                return new org.json.JSONArray(o);
            }
            if (o instanceof Map) {
